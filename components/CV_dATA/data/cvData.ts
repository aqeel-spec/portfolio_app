...
export const personalData = {
  ...
  education: [
    'Bachelor of Science in Mathematics, GC university Faisalabad(2018-2022)',
    'Completed in Cloud Native Computing, PIAIC Batch 4 Faisalabad (2020-2022)',
    'Certified in Ethical Hacking , PFTP (Pakistan freelancing program)',
  ],
  contactLinks: [
    'https://twitter.com/',
    'https://web.facebook.com/profile.php?id=100053063911716',
    'https://pk.linkedin.com/',
    'https://discord.com/channels/790484092772548613/928264948289777715',
  ],
}
